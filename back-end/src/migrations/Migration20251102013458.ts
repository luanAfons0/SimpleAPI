...
export class Migration20251102013458 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`alter table \`order_product\` drop index \`order_product_order_id_index\`;`);
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`alter table \`order_product\` drop index \`order_product_related_order_id_index\`;`);
